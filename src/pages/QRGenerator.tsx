      ...
      <div className="max-w-4xl mx-auto">
        <header className="flex justify-between items-center mb-8 no-print">
          ...
          <button 
            ...
            className="bg-[#FF5C00] text-white px-6 py-3 rounded-2xl font-black flex items-center gap-2 shadow-lg hover:brightness-110 transition"
          >
            <Printer size={20} /> Print All Codes
          </button>
        </header>

        <div className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-gray-100 mb-8 no-print">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 print-grid">
          {Array.from({ length: tableCount }).map((_, i) => {
            ...
            return (
              <div key={tableNum} className="bg-white p-8 rounded-[2.5rem] border-2 border-dashed border-gray-200 flex flex-col items-center text-center">
                ...
                <p className="text-[10px] font-black text-[#FF5C00] uppercase tracking-[0.2em]">Scan to Order</p>
